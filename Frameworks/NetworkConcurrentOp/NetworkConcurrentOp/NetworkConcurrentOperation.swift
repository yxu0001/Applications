...
public class NetworkConcurrentOperation: ConcurrentOperation {
    ...
    public init(withUrl url: NSURL, httpMethod: HTTPMethod, postData: NSData?, httpHeaders: NSDictionary?) {
        self.url = url
    ...
    public convenience init(withUrl url: NSURL) {
